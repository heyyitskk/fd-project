                    ...
                    {orderData ? Array(orderData).map(data => {
                        return (
                            data.orderData ?
                                                    ...
                                                    {arrayData.Order_date ? <div className='m-auto mt-5'>
                                                        ...
                                                        <div className='col-12 col-md-6 col-lg-3' >
                                                            <div className="card mt-3" style={{ width: "16rem", maxHeight: "360px" }}>
                                                                <img src={arrayData.img} className="card-img-top" alt="..." style={{ height: "150px", objectFit: "fill" }} />
                                ...
                                }) : <div style={{ fontSize: "30px", padding: "40px", textAlign: "center" }}>No order placed!</div>
                        )
                    }) : ""}
                </div>
